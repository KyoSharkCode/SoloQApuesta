...
def obtener_datos():
    ...
    if os.path.exists("datos.json"):
        try:
            with open("datos.json", "r", encoding="utf-8") as f:
                ...
                # Soportar si el json era lista o diccionario
    ...
    lista_final = []
    fecha_actual = datetime.now().strftime("%d/%m %H:%M")
    ...
    # Guardamos con formato de diccionario para tener metadatos
    datos_exportar = {
